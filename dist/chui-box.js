...
$.extend({
  Box: function(globalObject) {
      ...
      function each(iterator, callback) {
        ...
        var promise = self.ready().then(function() {
          ...
          for (var i = 0; i < length; i++) {
            ...
            var value = localStorage.get(_key2);
            if (value) {
    ...
    (function() {
      ...
      var BLOB_TYPE_PREFIX = '~~chui_box_type~';
      var BLOB_TYPE_PREFIX_REGEX = /^~~chui_box_type~([^~]+)~/;
      ...
      function bufferToString(buffer) {
        ...
        var base64String = '';
        var i = undefined;
        for (i = 0; i < bytes.length; i += 3) { /*jslint bitwise: true */
        ...
        var promise = new Promise(function(resolve, reject) {
          try {
            var _ret = function() {
              ...
              var complianceError = new Error('Custom driver not compliant; see ChocolateChip-UI Box documentation');
